...
public class ReservasView extends JFrame {
	...
	private ReservasContoller reservasController;
	...
	public ReservasView() {
		...
		this.reservasController = new ReservasContoller();
		...
		lblTitulo.setBounds(106, 61, 251, 42);
		...
		txtValor.setBounds(69, 328, 288, 31);
	...
	private void guardar() {
		...
		String fechaout = ((JTextField) txtFechaSalida.getDateEditor().getUiComponent()).getText();
			...
			nuevaReserva = new Reservas(Date.valueOf(fechaIn), Date.valueOf(fechaout),
					Double.parseDouble(txtValor.getText()), txtFormaPago.getSelectedItem().toString());
